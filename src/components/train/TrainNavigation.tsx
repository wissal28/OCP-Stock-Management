import { AlertOctagon, History, LayoutDashboard, PackageOpen } from "lucide-react";

export type TrainSection = "vue" | "trains" | "arrets" | "historique";

const SECTIONS: { key: TrainSection; label: string; Icon: typeof PackageOpen }[] = [
  { key: "vue", label: "Vue d'ensemble", Icon: LayoutDashboard },
  { key: "trains", label: "Trains & déchargement", Icon: PackageOpen },
...
export default function TrainNavigation({
  ...
  active: TrainSection;
  onChange: (section: TrainSection) => void;
}) {
  return (
